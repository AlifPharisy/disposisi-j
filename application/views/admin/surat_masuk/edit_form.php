...
<input class="form-control" type="text" name="surat_from" value="<?=$surat->surat_from;?>" placeholder="SURAT sDARI" required />
</div>
<div class="mb-3">
...
<div class="mb-3">
<label for="username">KETERANGANs<code>*</code></label>
